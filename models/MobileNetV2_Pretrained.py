...
MobileNet_Pretrained_results_dir = os.path.join("results", "MobileNetV2_Pretrained")
results_dir = os.path.join(MobileNet_Pretrained_results_dir, f"run_{run_id}")
...
model_path = os.path.join(results_dir, "MobileNetV2_Pretrained_model.pth")
...
excel_path = os.path.join(results_dir, "MobileNetV2_Pretrained_results.xlsx")
...
csv_path = os.path.join(results_dir, "MobileNetV2_Pretrained_per_image_predictions.csv")
